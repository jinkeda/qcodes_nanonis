...
**Likely command-definition bugs (actionable): 9** — `File.datLoad`, `MProbeCurrent.Get`, `PLLPhasSwp.Start`, `PLLPhasSwp.Stop`, `PLLQCtrl.PhaseGet`, `Scan.PropsSet`, `Script.ChsGet`, `Script.LUTDeploy`, `TCPLog.StatusGet`
