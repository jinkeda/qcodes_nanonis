...
from nanonis.workflows.scan import ScanRegion, scan_coordinate_grids


def test_unrotated_pixel_centres():
    frame = ScanRegion(center_x=0.0, center_y=0.0, width=4.0, height=4.0, angle=0.0)
...
def test_center_offset_translates():
    frame = ScanRegion(center_x=10.0, center_y=-5.0, width=4.0, height=4.0, angle=0.0)
...
def test_rotation_matches_frame_corners_convention():
    ...
    frame = ScanRegion(center_x=0.0, center_y=0.0, width=2.0, height=2.0, angle=90.0)
